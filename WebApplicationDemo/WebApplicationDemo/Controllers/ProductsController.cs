...
namespace WebApplicationDemo.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult ProductList()
        {
            ...
            plist.Add(new ElectronicProducts { Productid = 2, ProductName = "powerbank", Price = 4000 });
        ...
        public ActionResult ShowNumbers()
        {
            ...
            //return View(intList); // This is not allowed
            return View();
        }
        ...
        public ActionResult AvailableProducts()
        {
            ...
            available.Add(new ElectronicProducts { Productid = 11, ProductName = "Printer", Price = 20000 });
            available.Add(new ElectronicProducts { Productid = 12, ProductName = "Sacnner", Price = 30000 });
